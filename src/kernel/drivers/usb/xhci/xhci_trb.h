...
_Static_assert(sizeof(xhci_trb_t) == sizeof(uint32_t) * 4,
               "xhci_trb_t must be 16 bytes");
...
_Static_assert(sizeof(xhci_command_completion_trb_t) == sizeof(uint32_t) * 4,
               "xhci_command_completion_trb_t must be 16 bytes");\
